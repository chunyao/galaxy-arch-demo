...
then
  echo "dev"
  php app.php --env=dev --url=https://dev-nacos.mabangerp.com  --dataId=mico_service --group=V2SYSTEM_GROUP  --tenant= --server.port=8080 --management.server.port=8081 --log.path=/data/logs
fi
