...
// 扫描$con目录下的所有文件
       // echo ROOT_PATH.DIRECTORY_SEPARATOR."service-main".DIRECTORY_SEPARATOR."src".DIRECTORY_SEPARATOR."App".DIRECTORY_SEPARATOR."Config".DIRECTORY_SEPARATOR."\n";
        $filename = scandir(ROOT_PATH.DIRECTORY_SEPARATOR."service-main".DIRECTORY_SEPARATOR."src".DIRECTORY_SEPARATOR."App".DIRECTORY_SEPARATOR."XxlJob".DIRECTORY_SEPARATOR);
...
// 定义一个数组接收文件名
        ...
        foreach ($filename as $k => $v) {
            ...
            $conname[substr($v, 0, strpos($v, "."))] = "\\App\\XxlJob\\".substr($v, 0, strpos($v, "."));
